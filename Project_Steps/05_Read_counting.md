...
<div style="display: flex; justify-content: center; gap: 20px;">
  <div style="text-align: center;">
    <img src="../Plots/Gen_expr_BH.png" width="350">
    <div><strong>Gen expression in control</strong></div>
  </div>
  <div style="text-align: center;">
    <img src="../Plots/Gen_expr_Serum.png" width="350">
    <div><strong>Gen expression in Serum</strong></div>
  </div>
</div>
